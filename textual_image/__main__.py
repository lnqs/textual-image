...
parser.add_argument(
    "--image",
    help="Path to an image file to use for the demo. If not provided, a default image will be used.",
    default=Path(__file__).parent / "gracehopper.jpg",
    type=path_exists,
)
parser.add_argument(
    "--transparent",
    action="store_true",
    help="Use a transparent background for the demo (only applicable to the Textual mode).",
)
