...
def test_image_size_cell_size_calculation() -> None:
    ...
    assert ImageSize(256, 256, None, None).get_cell_size(100, 100, CELL_SIZE) == (32, 16)
    ...
    assert ImageSize(256, 256, "auto", 50).get_cell_size(100, 100, CELL_SIZE) == (100, 50)
    assert ImageSize(256, 256, "auto", None).get_cell_size(32, 32, CELL_SIZE) == (32, 16)
    assert ImageSize(256, 256, None, "auto").get_cell_size(32, 32, CELL_SIZE) == (32, 32)
    assert ImageSize(12, 512, "auto", "auto").get_cell_size(32, 32, CELL_SIZE) == (2, 32)


def test_image_size_pixel_size_calculation() -> None:
    assert ImageSize(256, 256, None, None).get_pixel_size(100, 100, CELL_SIZE) == (256, 256)
